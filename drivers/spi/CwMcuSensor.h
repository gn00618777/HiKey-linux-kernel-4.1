...
enum VOCIE_RECOGNITION_RESPONSE {
    FLASH_WRITE_NO_ERROR = 0,
    BUSY_PROCESS = 1,
    CRC_ERROR = 2,
    FLASH_WRITE_ERROR = 3,
};

enum VOCIE_RECOGNITION_CMD {
    START_VOICE_RECO = 0,
    STOP_VOICE_RECO = 1,
    SELECT_MODE = 2,
    LOAD_ENROLLMENTFILE = 3,
    STOP_STREAMING	= 4,
    TRIGGER_TO_SEARCH = 5,
	FIN_STREAMING = 6,
	TRIGGER_TO_SEARCH_TIMEOUT = 7
};

enum VOCIE_RECOGNITION_MODE{
	TRIGGER_MODE = 1,
	COMMAND_MODE = 2,
	TRIGGER_TO_SEARCH_MODE = 3,
};
...
typedef enum {
	...
	*/
    ...
    RegMapW_VoiceRecoSelectMode               = 0x93,
    RegMapW_VoiceRecoStartBinaryFileLoading   = 0x94,
    RegMapW_VoiceRecoSendNextBinaryChunk      = 0x95,
    RegMapR_VoiceRecoGetAmountOfData          = 0x96,
