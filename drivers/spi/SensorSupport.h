...
#define SP_VOICE_RECOGNITION                (CWM_SUPPORT)
#define SP_TOUCH                            (CWM_SUPPORT)
...
#define SP_CYW_RESERVE_SENSOR_A             (CWM_NOT_SUPPORT)
#define SP_CYW_CONTEXT_AWARENESS            (CWM_NOT_SUPPORT)
...
typedef enum {
    ...
    emCYW_FALL  ,
#endif
#if SP_CYW_RESERVE_SENSOR_A
    emCYW_RESERVE_SENSOR_A  ,
#endif
...
#endif
#if SP_VOICE_RECOGNITION
#define VOICE_RECOGNITION                   (emVOICE_RECOGNITION)
#endif
#if SP_TOUCH
#define TOUCH                               (emTOUCH)
#endif
#if SP_ORIENTATION
...
#endif
#if SP_CYW_HAND_UP
#define CYW_HAND_UP_1                       (emCYW_HAND_UP)
#endif
#if SP_CYW_HAND_DOWN
...
#endif
#if SP_CYW_RESERVE_SENSOR_A
#define CYW_RESERVE_SENSOR_A                (emCYW_RESERVE_SENSOR_A)
#endif
#if SP_CYW_CONTEXT_AWARENESS
